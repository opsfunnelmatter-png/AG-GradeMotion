    ...
    <div class="layout-grid">
        ...
        <div>
            ...
            <div class="content-card">
                ...
                <div style="background: var(--bg-subtle); border-radius: var(--radius-md); padding: 16px 20px; margin-top: 14px; display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 14px;">
                    ...
                    <a href="/#cta" class="nav-btn" style="font-size: 13px; padding: 8px 16px;">
                        Book Free Diagnostic &rarr;
                    </a>
                </div>
            </div>
        ...
        <aside class="sidebar">
            ...
            <div class="cta-box">
                ...
                <h3>Further Maths Diagnostic for ${escapeHtml(loc.city)}</h3>
                <p>
                    Experience Tutor Sheefa's diagnostic methodology firsthand with zero obligation. We evaluate your past papers, isolate syllabus gaps, and structure your roadmap to an A/A*.
                </p>
                <a href="/#cta" class="btn-main">Book Free Diagnostic Session &rarr;</a>
                <div style="margin-top: 8px; text-align: center;">
                    <a href="/#pricing" style="color: rgba(255,255,255,0.9); font-size: 12px; text-decoration: underline;">Explore All Sprint Plans &amp; Pricing &rarr;</a>
                </div>
