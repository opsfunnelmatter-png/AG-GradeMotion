    ...
    function openModal(packageType = "diagnostic") {
        ...
        if (packageType === "standard") {
            if (curr === 'MYR') {
                ...
                if (submitBtnEl) submitBtnEl.innerHTML = "Topic Surgery (RM 1,440) &rarr;";
                if (subjectEl) subjectEl.value = "New Further Math Topic Surgery Sprint (RM 1,440 MYR)";
            } else {
                if (titleEl) titleEl.innerText = "Apply for Topic Surgery Sprint (8 Hours)";
            ...
            if (curr === 'MYR') {
                ...
                if (submitBtnEl) submitBtnEl.innerHTML = "Exam Readiness (RM 2,560) &rarr;";
                if (subjectEl) subjectEl.value = "New Further Math Exam Readiness Sprint (RM 2,560 MYR)";
            } else {
                if (titleEl) titleEl.innerText = "Apply for Exam Readiness Sprint (16 Hours)";
